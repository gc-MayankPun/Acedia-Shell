...
Canvas {
    ...
    // They are default to the Theme constraints so the shape is never empty.
    property int leftWidth: Config.Theme.lNotchMinWidth
    property int centerWidth: Config.Theme.cNotchMinWidth
    property int rightWidth: Config.Theme.rNotchMinWidth

    property int notchHeight: Config.Theme.notchHeight
    property int radius: Config.Theme.notchRadius
    property int topBorderWidth: Config.Theme.borderWidth
